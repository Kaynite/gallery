        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <!-- Navigation Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex" v-if="isAuthenticated">
                        <router-link
                            exact-active-class="border-b-2 border-indigo-400"
                            :to="{ name: 'Upload' }"
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <div class="relative" v-if="isAuthenticated">
                        <div @click="isOpen = !isOpen" v-click-away="closeMenu">
                            <button
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <form method="POST" action="http://127.0.0.1:8000/logout">
                        <input
                            type="hidden"
                            name="_token"
                            value="lXZVKt6ffmk1d3KSrDDCwwwQjQSZjMpBGRzaK0Cm"
                        />
                        <a
